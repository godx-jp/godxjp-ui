...
**This catalog describes `@godxjp/ui` 28.5.0.** If the project you are editing has a different
...
3. `rules.json` — 47 cardinal rules. The ones about raw HTML and hardcoded colour are not
   style advice.
4. `tokens.json` — 1617 design tokens. Only when you need a specific knob's name.
