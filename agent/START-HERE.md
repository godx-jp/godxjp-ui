...
**This catalog describes `@godxjp/ui` 28.9.1.** If the project you are editing has a different
...
3. `rules.json` — 47 cardinal rules. The ones about raw HTML and hardcoded colour are not
   style advice.
4. `tokens.json` — 1683 design tokens. Only when you need a specific knob's name.
