 ...
 *
 * "THE TWO STATES DO NOT RENDER IDENTICALLY" WAS ASSERTED HERE AND HAS MOVED to
 * `scripts/check-state-legible.mjs` (gh#615 → gh#622). It could only ever ask that of the four
 * surfaces below, because assertions 1-6 need a real `<input>` inside the painted box — and `Tabs`,
 * `Tree`, `ToggleGroup`, `Steps`, `Pagination` and a selected `DataTable` row have none. Keeping it
 * here would have frozen the coverage at four. It is a WCAG 1.4.1 question, not a hit-target one.
 */
