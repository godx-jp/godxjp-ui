...
export function Topbar({
  ...
  const collapsed = useCollapsesToMenu(barRef, overflow === "menu" && children == null);
  const clusters = (
    <>
      {start != null ? (
 ...
 */
function useCollapsesToMenu(ref: React.RefObject<HTMLDivElement | null>, enabled: boolean): boolean {
