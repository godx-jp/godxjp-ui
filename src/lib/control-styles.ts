...
export const controlTriggerBaseClass =
  "ui-control ui-control-trigger flex items-center justify-between gap-2 whitespace-nowrap rounded-[var(--control-radius)] transition-[color,box-shadow] focus-visible:outline-none [&>span]:line-clamp-1";
