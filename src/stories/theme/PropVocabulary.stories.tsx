...
const rows: Row[] = [
  ...
  },
  {
    prop: "color",
    type:
      "\\"primary\\" | \\"success\\" | \\"warning\\" | \\"attention\\" | \\"info\\" | \\"destructive\\" | \\"default\\"",
    concept:
      "Semantic role — maps to a semantic token. Use 'attention' for non-destructive alerts.",
    usedBy: ["Tag", "Badge", "Alert", "Statistic (delta)", "Dot", "IconSquare"],
  },
  ...
  },
  {
    prop: "accent",
    type:
      "\\"primary\\" | \\"success\\" | \\"warning\\" | \\"attention\\" | \\"info\\" | \\"destructive\\" | \\"featured\\"",
    concept: "Edge indicator (3px left edge or full --primary ring).",
    usedBy: ["Card"],
  },
  {
...
export function PropVocabularyTable() {
  return (
    <Table
      density="compact"
      stickyHeader
...
const columns: TableColumn<ForbiddenRow>[] = [
  {
    accessorKey: "forbidden",
    header: "Forbidden",
    cell: ({ row }) => (
...
export function ForbiddenSynonymsTable() {
  return (
    <Table
      density="compact"
      containerClassName="card"
