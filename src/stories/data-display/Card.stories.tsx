    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-[14px]">
      ...
      <Card>
        ...
        <div className="row-between" style={{ alignItems: "flex-end" }}>
          <div className="stat">
            168.5<span className="unit">h</span>
          </div>
        ...
        >
          <div>
            <div className="stat" style={{ fontSize: 20 }}>
              12.0<span className="unit">日</span>
            </div>
          ...
          <div>
            <div className="stat muted" style={{ fontSize: 20 }}>
              8.0<span className="unit">日</span>
            </div>
            <div className="muted" style={{ fontSize: 10 }}>
              取得済
            </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-[14px]">
        ...
        <div className="row-between">
          <div>
            ...
            <div className="muted" style={{ marginTop: 2, fontSize: 11 }}>
              先週 ¥ 4.55M ·{" "}
              <span className="delta up" style={{ padding: 0 }}>
                +5.9%
              </span>
            </div>
          </div>
          ...
          >
            <path
              d="M0,32 L15,28 L30,30 L45,22 L60,18 L75,24 L90,16 L105,10 L120,12"
              fill="none"
              stroke="var(--primary)"
              strokeWidth={1.5}
              strokeLinecap="round"
            ...
            />
            <path
              d="M0,32 L15,28 L30,30 L45,22 L60,18 L75,24 L90,16 L105,10 L120,12 L120,48 L0,48 Z"
      ...
      >
        ...
        <div className="card-footer-block">
          ...
          <span
            className="dot"
            style={{ background: "var(--border)", marginLeft: 10 }}
          />
          <span>未来</span>
          <span
            style={{
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-[14px]">
      ...
      <Card>
        ...
        >
          ...
          <div className="muted" style={{ fontSize: 11, paddingBottom: 4 }}>
            / ¥ 3.00M
          </div>
          <span
            className="delta up"
        ...
        <div className="muted" style={{ fontSize: 11, marginTop: 6 }}>
          目標まで 14 日 · 達成見込み{" "}
          <b style={{ color: "var(--success)" }}>○ オントラック</b>
        </div>
      </Card>
    </div>
  ),
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-[14px]">
      ...
      <Card tone="muted">
        ...
        <dl className="dl">
          ...
          <dt>交通費</dt>
          <dd>¥ 8,500</dd>
          <dt style={{ fontWeight: 500, color: "var(--foreground)" }}>
            支給合計
          </dt>
    ...
    <Card padding="none" title="店舗別売上 · 今月" meta="5月 1日 — 17日">
      <table className="mini-table">
        ...
        <tbody>
          ...
          <tr>
            <td className="muted">02</td>
            <td>表参道店</td>
            <td>¥ 3,142,800</td>
            <td>
              <span className="delta up">+8.1%</span>
            </td>
            <td>71%</td>
          </tr>
          <tr>
            <td className="muted">03</td>
            <td>自由が丘店</td>
            <td>¥ 2,890,300</td>
            <td>
          ...
          <tr>
            <td className="muted">04</td>
            <td>新宿西口店</td>
            <td>¥ 2,104,200</td>
            <td>
              <span className="delta flat">±0.0%</span>
            </td>
            <td>52%</td>
          </tr>
        </tbody>
  ...
  render: () => (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-[14px]">
      <Card padding="none">
        ...
        <div className="card-body-block">
          ...
          >
            ...
            <div style={{ display: "flex", gap: 6, paddingBottom: 2 }}>
              <Button variant="outline" size="x-small">
                メッセージ
              </Button>
        ...
        <div
          className="card-footer-block"
          style={{ gap: 18, color: "var(--foreground)" }}
        >
          <div>
            <div className="tnum" style={{ fontSize: 14, fontWeight: 600 }}>
              12
            </div>
            <div className="muted" style={{ fontSize: 10 }}>
              担当チーム
      ...
      <Card>
        ...
        >
          <Button variant="secondary" size="x-small" style={{ flex: 1 }}>
            プロフィール
          </Button>
          <Button variant="outline" size="x-small" style={{ flex: 1 }}>
            1on1 予約
          </Button>
        </div>
      </Card>
  ...
  render: () => (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-[14px]">
      ...
      <Card>
        ...
        <div className="muted" style={{ fontSize: 11, lineHeight: 1.55 }}>
          ベトナム料理レストラン · 4 店舗 · 従業員 38 名
        </div>
        <div style={{ display: "flex", gap: 14, marginTop: 12, fontSize: 11 }}>
          <div>
            <span className="muted">プラン</span> <b>Pro</b>
          </div>
          <div>
            <span className="muted">期限</span> 2027/03
          </div>
          <div>
            <span className="muted">ID</span> <span className="mono">btya</span>
          </div>
        </div>
      </Card>
    </div>
...
const Check = () => (
  <svg
    className="si-sm"
    style={{ color: "var(--success)", marginTop: 3 }}
    viewBox="0 0 24 24"
    fill="none"
    stroke="currentColor"
    strokeWidth={2.5}
...
export const C1_ArticleProduct: Story = {
  ...
  render: () => (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-[14px]">
      <Card padding="none">
        <div className="ph striped tinted-leaf" style={{ aspectRatio: "16/9" }}>
          1280 × 720 · article hero
        </div>
        <div className="card-body-block" style={{ padding: "12px 14px 14px" }}>
          <div
            style={{
              display: "flex",
              gap: 6,
          ...
          <div style={{ fontSize: 13, fontWeight: 500, lineHeight: 1.5 }}>
            2026 年 6 月リリース予定の新機能と移行ガイド
          </div>
          <div
            className="muted"
            style={{ fontSize: 11, lineHeight: 1.55, marginTop: 6 }}
          >
      ...
      <Card padding="none">
        <div className="ph striped tinted-warm" style={{ aspectRatio: "1" }}>
          800 × 800 · 商品写真
        </div>
        <div className="card-body-block" style={{ padding: "12px 14px 14px" }}>
          ...
          <Button size="small" block style={{ marginTop: 10 }}>
            カートに追加
          </Button>
        </div>
      </Card>
  ...
  render: () => (
    ...
    >
      <Card>
        ...
        <Button variant="outline" block style={{ marginTop: 14 }}>
          現在のプラン
        </Button>
      </Card>
  ...
  render: () => (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-[14px]">
      <Card>
        ...
        <div
          className="muted"
          style={{ fontSize: 11, lineHeight: 1.55, marginTop: 4 }}
        >
          GPS 確認 + 顔認証で不正打刻を防止。1 秒以内に承認されます。
        </div>
        <a className="lnk" style={{ marginTop: 10, display: "inline-block" }}>
          設定する →
        </a>
      </Card>
      <Card>
        ...
        <div
          ...
          style={{ fontSize: 11, lineHeight: 1.55, marginTop: 4 }}
        >
          勤怠データから残業・深夜・手当を自動計算。マネーフォワード / freee
          と連携。
        </div>
        <a className="lnk" style={{ marginTop: 10, display: "inline-block" }}>
          連携する →
      ...
      <Card>
        ...
        <div
          ...
          style={{ fontSize: 11, lineHeight: 1.55, marginTop: 4 }}
        >
          店舗ごとにブランドカラー · 言語 · 通貨を切替。本部からは横断 KPI
          を一望。
        </div>
        <a className="lnk" style={{ marginTop: 10, display: "inline-block" }}>
          追加する →
      ...
      <Card>
        <div className="row-between" style={{ marginBottom: 10 }}>
          <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
            <span
              className="ic xl"
              style={{ background: "#4A154B", color: "white", border: 0 }}
            >
              S
            </span>
            <div>
      ...
      <Card>
        <div className="row-between" style={{ marginBottom: 10 }}>
          <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
            <span
              className="ic xl"
              style={{ background: "#0061FF", color: "white", border: 0 }}
            >
              G
            </span>
            <div>
...
export const D1_Approval: Story = {
  ...
  render: () => (
    <Card
      ...
      title={
        <>
          <span className="ava sm" style={{ marginRight: 8 }}>
            山田
          </span>
          山田 太郎 · 有給休暇
        </>
    ...
    <Card>
      ...
      <div className="tl-list">
        <div className="tl-item success">
          <div className="t-h">
            <b>会社情報を入力</b>
            <span className="ts">完了 · 5/14</span>
          </div>
        ...
        <div className="tl-item success">
          <div className="t-h">
            <b>従業員をインポート</b>
            <span className="ts">完了 · 5/15</span>
          </div>
        ...
        <div className="tl-item current">
          <div className="t-h">
            <b>シフトテンプレートを作成</b>
            <span className="ts" style={{ color: "var(--primary)" }}>
              進行中
            </span>
          </div>
  ...
  render: () => (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-[14px]">
      <Card padding="cozy">
        ...
        >
          <Button size="large" style={{ height: 48, fontSize: 15 }}>
            出勤 · Check In
          </Button>
          <Button
            variant="outline"
      ...
      <Card padding="cozy" accent="info">
        ...
        <div className="stat lg" style={{ marginBottom: 4 }}>
          ¥ 8,420,500
        </div>
        <div className="muted" style={{ fontSize: 11 }}>
          38 名 · 振込日 5月 25日
  ...
  render: () => (
    <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ fontSize: 13, fontWeight: 500 }}>
            5月度の締めは 5/31 (土) 23:59 です
          </div>
          <div className="muted" style={{ fontSize: 11, marginTop: 1 }}>
            未承認の打刻修正がある場合、承認者へリマインドが送られます。
          </div>
        </div>
        <Button variant="ghost" size="x-small">
          詳細
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div className="muted" style={{ fontSize: 11, marginTop: 1 }}>
            該当日: 5/12, 5/13, 5/15 — 当事者へ修正依頼を送信できます。
          </div>
        </div>
        <Button variant="outline" size="x-small">
          確認
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-[14px]">
      <Card style={{ textAlign: "center", padding: "32px 16px" }}>
        ...
        <div className="muted" style={{ fontSize: 11, marginTop: 4 }}>
          別の月を選択するか、シフトを新規作成してください。
        </div>
        <Button variant="outline" size="small" style={{ marginTop: 14 }}>
          ＋ シフトを作成
        </Button>
      </Card>
      <Card
      ...
      >
        ...
        <div className="muted" style={{ fontSize: 11, marginTop: 4 }}>
          条件を見直すか、すべてクリアしてください。
        </div>
        <Button variant="ghost" size="small" style={{ marginTop: 14 }}>
          フィルタをクリア
        </Button>
      </Card>
    </div>
  ...
  render: () => (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-[14px]">
      ...
      <Card>
        ...
        <span
          className="sk"
          style={{ height: 28, width: "55%", borderRadius: 4 }}
        />
        <div style={{ height: 8 }} />
      ...
      <Card padding="none">
        ...
        >
          <div style={{ display: "flex", gap: 6 }}>
            <span
              className="sk"
              style={{ height: 18, borderRadius: 9, width: 64 }}
            />
            <span
              className="sk"
              style={{ height: 18, borderRadius: 9, width: 42 }}
            />
          </div>
        ...
        {[
          {
            name: "勤怠 API",
            up: "99.98% uptime",
            colors: Array(10).fill("var(--success)"),
          },
          {
            name: "給与連携 · freee API",
            up: "98.21% uptime",
          ...
          >
            <span
              className={`dot ${row.colors.every((c) => c === "var(--success)") ? "success pulse" : "warning"}`}
              style={{ color: "var(--success)" }}
            />
            <span style={{ flex: 1 }}>{row.name}</span>
            <span className="mono muted tnum" style={{ fontSize: 10 }}>
              {row.up}
            </span>
            <span style={{ display: "flex", gap: 1 }}>
              {row.colors.map((c, j) => (
                <i key={j} style={{ width: 3, height: 14, background: c }} />
              ))}
            </span>
          </li>
        ))}
    ...
    <div className="banner">
      ...
      >
        <div style={{ flex: 1, minWidth: 240 }}>
          ...
          >
            需要予測と従業員のスキル ·
            希望を基に、最適なシフトを自動生成。試験運用に参加してください。
          </div>
        </div>
        <div style={{ display: "flex", gap: 8 }}>
          ...
          <Button
            size="small"
            style={{ background: "white", color: "var(--wa-kon)" }}
          >
            試験運用に参加
          </Button>
        </div>
  ...
  render: () => (
    ...
    >
      <div className="cal-day">
        <span className="d">月 12</span>
        <span className="time">8:00–17:00</span>
        <span className="role">早番 · キッチン</span>
      </div>
      <div className="cal-day">
        <span className="d">火 13</span>
        <span className="time">11:00–20:00</span>
        <span className="role">中番 · ホール</span>
      </div>
      <div className="cal-day">
        <span className="d">水 14</span>
        <span className="time muted">休</span>
        <span className="role">公休</span>
      </div>
      <div className="cal-day">
        <span className="d">木 15</span>
        <span className="time">8:00–17:00</span>
        <span className="role">早番 · キッチン</span>
      </div>
      <div className="cal-day today">
        <span className="d" style={{ color: "var(--primary)" }}>
          金 17 · 本日
        </span>
        <span className="time">8:00–17:00</span>
        <span className="role">早番 · キッチン</span>
      ...
      <div className="cal-day">
        <span className="d" style={{ color: "var(--attention)" }}>
          土 18
        </span>
        <span className="time" style={{ color: "var(--attention)" }}>
          未割当
        </span>
        <span className="role">遅番候補</span>
      </div>
      <div className="cal-day">
        <span className="d" style={{ color: "var(--destructive)" }}>
          日 19
        </span>
        <span className="time">休</span>
        <span className="role">公休</span>
      </div>
    </div>
  ),
  ...
  render: () => (
    <Card>
      <div className="tl-log">
        <div className="row">
          <span className="ts">14:35:02</span>
          <span className="lv s">OK </span>
          <span className="msg">
            <b>punch.create</b> 田中 美咲 出勤 @ 渋谷本店
          </span>
        </div>
        <div className="row">
          <span className="ts">14:35:12</span>
          <span className="lv i">INF</span>
          <span className="msg">
            <b>shift.match</b> matched 早番 (8:00–17:00)
          </span>
        </div>
        <div className="row">
          <span className="ts">14:36:48</span>
          <span className="lv w">WRN</span>
          <span className="msg">
            <b>geo.distance</b> 8m from 店舗 — within tolerance
          </span>
        </div>
        <div className="row">
          <span className="ts">14:38:15</span>
          <span className="lv s">OK </span>
          <span className="msg">
            <b>notify.slack</b> #attendance posted
          </span>
        </div>
        <div className="row">
          <span className="ts">14:42:01</span>
          <span className="lv e">ERR</span>
          <span className="msg">
            <b>freee.sync</b> token expired · retry queued
          </span>
        </div>
        <div className="row">
          <span className="ts">14:42:30</span>
          <span className="lv d">DBG</span>
          <span className="msg">
            <b>retry.scheduler</b> next attempt in 60s
          </span>
        </div>
        <div className="row">
          <span className="ts">14:43:30</span>
          <span className="lv s">OK </span>
          <span className="msg">
            <b>freee.sync</b> resumed · 142 records pushed
          </span>
        </div>
      </div>
    </Card>
      ...
      <Card>
        <div className="steps-h">
          <div className="step done">
            ...
            <span className="lbl">情報入力</span>
            <span className="sub">5/14 09:22</span>
          </div>
          <div className="step done">
            <span className="node">
              <StepCheck />
            ...
            <span className="sub">5/14 09:24</span>
          </div>
          <div className="step cur">
            <span className="node">3</span>
            <span className="lbl">承認待ち</span>
            <span className="sub">進行中</span>
          </div>
  ...
  render: () => (
    <Card>
      <div className="tl-grp">
        <div className="grp-h">
          2026/05/17 (土) <span className="badge">本日</span>
        ...
        <div className="row">
          ...
          <div className="body">
            <b>田中 美咲</b>が承認しました
            <div className="meta">山田 太郎 の有給申請 (5/22–5/23)</div>
          </div>
        </div>
        <div className="row">
          <span className="ts">11:12</span>
          <div className="body">
            <b>Nguyễn Lan</b>が打刻 · 出勤
            <div className="meta">ベトヤ表参道 · 11:12:08 JST</div>
          </div>
        </div>
        <div className="row">
          ...
          <div className="body">
            <b>田中 美咲</b>が打刻 · 出勤
            <div className="meta">渋谷本店 · GPS 確認済</div>
          </div>
        </div>
        <div className="grp-h">
          2026/05/16 (金)
        ...
        <div className="row">
          ...
          <div className="body">
            システム · 月次レポート生成完了
            <div className="meta">5月度 第 2 週 · 自動配信</div>
          </div>
        </div>
        <div className="row">
          ...
          <div className="body">
            <b>佐藤 健一</b>が休暇申請
            <div className="meta">5/24 半休 (午後) · 私用</div>
          </div>
        </div>
      </div>
    </Card>
    ...
    <Card>
      <div className="tl-br">
        <div className="row success">
          ...
          <div className="node" />
          <div className="body">
            <div className="t">山田 太郎 が申請を提出</div>
            <div className="d">有給休暇 · 5/22–5/23 · 2 日</div>
          </div>
        </div>
        <div className="row success">
          ...
          <div className="node" />
          <div className="body">
            <div className="t">田中 美咲 (一次承認) が承認</div>
            <div className="d">コメント: 業務影響なし · 引継ぎ済</div>
          </div>
        </div>
        <div className="row current">
          ...
          <div className="node" />
          <div className="body">
            <div className="t" style={{ color: "var(--primary)" }}>
              人事部 (最終承認) を待っています
            </div>
    ...
    <Card>
      <div className="tl-feed">
        <div className="item">
          ...
          <div className="body">
            <div className="h">
              <b>田中 美咲</b>が<a className="lnk">山田 太郎</a>
              の申請にコメントしました<span className="ts">5 分前</span>
            </div>
            <div className="d">承認前のひとこと:</div>
            <div className="qbox">
              23日は店舗営業時間が短縮なので、振替は来週月曜で OK です。
            </div>
          </div>
        </div>
        <div className="item">
          ...
          <div className="body">
            <div className="h">
              <b>Nguyễn Lan</b>が新しいシフトに割当てられました
              <span className="ts">14:35</span>
            </div>
        ...
        <div className="item">
          ...
          <div className="body">
            <div className="h">
              <b>佐藤 健一</b>がプロフィール写真を更新
              <span className="ts">2 時間前</span>
            </div>
          </div>
        </div>
        <div className="item">
          ...
          <div className="body">
            <div className="h">
              ...
              チームに参加<span className="ts">昨日</span>
            </div>
          </div>
        </div>
      </div>
...
export const G1_PlainRules: Story = {
  ...
  render: () => (
    <Card>
      ...
      <div className="muted" style={{ fontSize: 12, marginBottom: 0 }}>
        After gradient
      </div>
    </Card>
  ),
  ...
  render: () => (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-[14px]">
      ...
      <Card>
        ...
        <div className="dv-chip">
          <span className="pill" style={{ background: "var(--secondary)" }}>
            あるいは
          </span>
        </div>
        <Button variant="ghost" size="small" block>
          マジックリンクを送信
        </Button>
      </Card>
    </div>
  ...
  render: () => (
    <Card>
      ...
      <div className="dv-section">
        ...
        <span className="meta" style={{ color: "var(--attention)" }}>
          未保存
        </span>
      </div>
      <div className="muted" style={{ fontSize: 12, marginBottom: 6 }}>
        基本給 ¥240,000 · 通勤費 ¥8,500 …
      </div>
      <div className="dv-section">
  ...
  render: () => (
    <Card>
      <div className="dv-date">
        <span className="pill">2026/05/14 木</span>
      </div>
      <div
        style={{
          display: "flex",
      ...
      <div className="dv-date">
        <span className="pill">2026/05/15 金 · 本日</span>
      </div>
      <div
        style={{
          display: "flex",
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-[14px]">
      ...
      <Card>
        ...
        <div className="dv-stack dashed">
          ...
          >
            <span>基本給</span>
            <span className="mono">¥ 240,000</span>
          </div>
          <div
            style={{
              fontSize: 12,
          ...
          >
            <span>残業手当</span>
            <span className="mono">¥ 22,800</span>
          </div>
          <div
            style={{
              fontSize: 12,
          ...
          >
            <span>交通費</span>
            <span className="mono">¥ 8,500</span>
          </div>
          <div
            style={{
              fontSize: 12,
          ...
          >
            <span>合計</span>
            <span className="mono">¥ 271,300</span>
          </div>
        </div>
      </Card>
    </div>
...
export const G6_VerticalDivider: Story = {
  ...
  render: () => (
    ...
    >
      <span>
        <b>168.5h</b> <span className="muted">実働</span>
      </span>
      <hr className="dv vert" />
      <span>
        <b>12.5h</b> <span className="muted">残業</span>
      </span>
      <hr className="dv vert" />
      <span>
        <b>1.0日</b> <span className="muted">有給</span>
      </span>
      <hr className="dv vert" />
      <span>
        <b>22</b> <span className="muted">出勤日</span>
      </span>
      <hr className="dv vert" />
      <span>
        <b>¥271K</b> <span className="muted">給与</span>
      </span>
      <span style={{ marginLeft: "auto" }}>
        <a className="lnk">詳細 →</a>
      </span>
    </Card>
  ),
};
  ...
  render: () => (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-[14px]">
      <Card padding="none" title="タイトルのみ">
        <div className="card-body-block muted" style={{ fontSize: 11 }}>
...
export const H4_H5_WithActions: Story = {
  ...
  render: () => (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-[14px]">
      ...
      >
        <div className="card-body-block muted" style={{ fontSize: 11 }}>
          Icon-only buttons phía bên trái, labeled buttons phía bên phải — luôn
          theo thứ tự danger → standard → primary.
        </div>
      </Card>
    </div>
  ),
  ...
  render: () => (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-[14px]">
      <Card padding="none">
        ...
        <div className="card-body-block muted" style={{ fontSize: 11 }}>
          Icon w/ tinted background — semantic. Phù hợp cho stat cards có
          category rõ ràng.
        </div>
      </Card>
      <Card padding="none">
        ...
        <div className="card-body-block muted" style={{ fontSize: 11 }}>
          Avatar — chuyên cho entity card (người, công ty, team). Status dot bên
          phải.
        </div>
      </Card>
    </div>
    ...
    <Card padding="none">
      <div className="card-header-tabs">
        ...
        <button type="button" className="tab on">
          月次 <span className="pill">22</span>
        </button>
        ...
        <button type="button" className="tab">
          ...
          <span
            ...
            style={{
              background:
                "color-mix(in oklch, var(--attention) 18%, transparent)",
              color: "var(--attention)",
            }}
          >
            3
      ...
      <div className="card-body-block muted" style={{ fontSize: 11 }}>
        Tabs in-header — phù hợp cho card có 2–5 views cùng dataset. Count pill
        match màu trạng thái.
      </div>
    </Card>
  ),
};
  ...
  render: () => (
    <Card padding="none">
      <div className="card-header-filters">
        ...
        <Button variant="ghost" className="chip-fl on">
          渋谷本店
        </Button>
        <Button variant="ghost" className="chip-fl on">
          正社員
        </Button>
        <Button variant="ghost" className="chip-fl">
          遅刻あり
        </Button>
        <Button variant="ghost" className="chip-fl">
          ＋ 追加
      ...
      <div className="card-body-block muted" style={{ fontSize: 11 }}>
        Chips "đang active" có icon × để remove · clear-all không cần (×× từng
        cái dễ hơn).
      </div>
    </Card>
  ),
...
export const H10_Search: Story = {
  ...
  render: () => (
    <Card padding="none">
      ...
      <div className="card-body-block muted" style={{ fontSize: 11 }}>
        Search input căn phải, max-width 280px — không tràn cả header. Đếm
        result luôn cạnh title.
      </div>
    </Card>
  ),
};
      ...
      <Card padding="none">
        <div className="card-header-hero">
          ...
          <div className="actions">
            ...
            <Button variant="ghost" size="small" style={{ color: "white" }}>
              あとで
            </Button>
          </div>
        </div>
      ...
      <Card padding="none">
        <div className="card-header-hero warm">
          ...
          <div className="actions">
            <Button
              size="small"
              style={{ background: "white", color: "var(--wa-akane)" }}
            >
              詳細を見る
            </Button>
          </div>
    ...
    <Card padding="none">
      <div className="card-header-toolbar">
        ...
        <div className="seg">
          ...
          <Button variant="ghost" className="on">
            週
          </Button>
      ...
      <div className="card-body-block muted" style={{ fontSize: 11 }}>
        Calendar-style toolbar — view seg + date nav + primary action. Phổ biến
        nhất cho schedule UI.
      </div>
    </Card>
  ),
};
...
export const H16_Breadcrumb: Story = {
  ...
  render: () => (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-[14px]">
      <Card padding="none">
        <div
          className="card-header-stack card-header-block"
        ...
        >
          ...
          >
            <a className="lnk" style={{ fontWeight: 400 }}>
              famgia
            </a>
            <svg
              viewBox="0 0 24 24"
      ...
      <Card padding="none">
        <div
          className="card-header-row card-header-block"
          style={{
            background:
              "color-mix(in oklch, var(--secondary) 30%, var(--card))",
          }}
        >
          <Button
            variant="ghost"
        ...
        <div className="card-body-block muted" style={{ fontSize: 11 }}>
          Edit-mode header — back arrow + save status + actions. Background tint
          phân biệt với view mode.
        </div>
      </Card>
    </div>
  ),
  ...
  render: () => (
    <Card padding="none">
      ...
      >
        ...
        <span className="card-header-extra muted mono" style={{ fontSize: 11 }}>
          スクロール中
        </span>
      </div>
      <div
        className="card-body-block muted"
        style={{ fontSize: 11, maxHeight: 140, overflowY: "auto" }}
      >
        <div style={{ fontSize: 11, lineHeight: 1.7 }}>
          ...
          <br />
          2026/05/17 14:02 · ¥1,800 · 渋谷本店
          <br />
          2026/05/17 13:58 · ¥5,400 · 表参道店
          <br />
          2026/05/17 13:50 · ¥7,200 · 自由が丘店
          <br />
          2026/05/17 13:42 · ¥3,600 · 渋谷本店
          <br />
