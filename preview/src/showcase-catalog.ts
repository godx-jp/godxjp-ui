...
export const SHOWCASES: ShowcaseEntry[] = [
  ...
  { id: "settings-security-mfa", title: "セキュリティ / 2要素認証", description: "Màn cài đặt bảo mật làm ĐÚNG luật: ListRow cho factor (không trùng title=description), nút Xoá tone destructive, action phải-aligned auto-width (không full-width), icon lucide (không emoji), Avatar cho brand mark.", tag: "Settings", load: () => import("../../docs/showcase/settings-security-mfa") },
