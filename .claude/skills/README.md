...
| [`godx-ui-doc-writing`](./godx-ui-doc-writing/SKILL.md) | BEFORE editing any `.md` file in this repo — CLAUDE.md, AGENTS.md, docs/specs/, docs/, ADRs, SKILL.md, CHANGELOG.md. Frontmatter shape per file type, upstream-spec citation requirement, Diátaxis quadrant discipline, cardinal rules every doc must respect. |
...
- [`docs/specs/05-design-handoff-formats.md`](../../docs/specs/05-design-handoff-formats.md) — multi-format input + lint guardrails.
