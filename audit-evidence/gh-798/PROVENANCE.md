# gh#798 — where these screenshots came from
...
gh#798 is CLOSED. The durable guard is the regression test on `main`, not these images —
`src/components/data-display/__tests__/scroll-area-scrollbar-798.test.tsx` —
