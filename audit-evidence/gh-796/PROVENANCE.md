# gh#796 — where these screenshots came from
...
gh#796 is CLOSED. The durable guard is the regression test on `main`, not these images —
`src/styles/__tests__/calendar-full-width-block-796.test.ts` —
