...
| Segmented two-or-three way selector | [SegmentedControl](./SegmentedControl.md) |
...
- [SegmentedControl](./SegmentedControl.md) — compact pill-style alternative for 2–3 options.
