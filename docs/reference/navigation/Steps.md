...
- [Timeline](../data-display/Timeline.md) — for historical event lists rather than progress.
- [Progress](../feedback/Progress.md) — for continuous (percentage) progress instead of discrete steps.
