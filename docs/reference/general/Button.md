...
import { DropdownMenu } from "@godxjp/ui";
...
- [Dialog](../feedback/Dialog.md) — common Button trigger composition.
- [DropdownMenu](../navigation/DropdownMenu.md) — Button as DropdownMenu.
