...
| Progress through a finite workflow with a "current" step | [Steps](../navigation/Steps.md)     |
| Single ongoing operation with percent progress           | [Progress](../feedback/Progress.md) |
...
- [Steps](../navigation/Steps.md) — progress through a finite workflow with a "current" step.
- [Progress](../feedback/Progress.md) — single-operation percentage indicator.
