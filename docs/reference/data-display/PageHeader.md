...
<PageHeader
  breadcrumb={
    <Breadcrumb>
      <Breadcrumb href="#">GoDX</Breadcrumb>
      <Breadcrumb />
      <Breadcrumb href="#">勤怠</Breadcrumb>
      <Breadcrumb />
      <Breadcrumb current>月次レポート</Breadcrumb>
    </Breadcrumb>
  }
  title="店舗別 · 月次レポート"
  actions={
...
<PageHeader
  ...
  tabs={
    <Tabs defaultValue="overview">
      <Tabs>
        <Tabs value="overview">概要</Tabs>
        <Tabs value="employees">従業員</Tabs>
        <Tabs value="settings">設定</Tabs>
      </Tabs>
    </Tabs>
  }
/>
...
- [Breadcrumb](../navigation/Breadcrumb.md) — hierarchical location slot.
- [Tabs](../navigation/Tabs.md) — second-row tab strip.
