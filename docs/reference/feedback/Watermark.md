...
- When the watermark conveys legal status ("CONFIDENTIAL", "DRAFT"), repeat the wording in the surrounding copy (e.g. a [`Card subtitle`](../data-display/Card.md)) so screen readers and copy-paste workflows preserve the meaning.
...
- [Card](../data-display/Card.md) — typical content wrapper rendered underneath.
