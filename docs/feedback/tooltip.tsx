        ...
        <TooltipProvider delayDuration={300}>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Wrap a non-interactive icon in a span with tabIndex=0 so keyboard users can focus
                it. Explain accounting terms or beta features without cluttering the UI.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Flex direction="row" gap="sm" align="center">
