      ...
      <Flex direction="col" gap="lg">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              h1 20 / h2 18 / h3-h4 14-13px, weight 500. SEO/a11y: exactly one &lt;h1&gt; per page
              (the page title above); h2-h6 below never skip a level.
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <Flex direction="col" gap="xs">
              ...
              <span className="text-2xl [font-variant-numeric:normal]">
                ¥1,284,500 — proportional ✗
              </span>
            </Flex>
          </CardContent>
        </Card>
