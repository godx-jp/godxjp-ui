...
const COLUMNS: ColumnDef<Punch>[] = [
  ...
  },
  {
    ...
    align: "right",
    hiddenOnMobile: true,
    render: (r) => <span className="tabular-nums">{r.workH}</span>,
  },
  {
    key: "status",
    header: "状態",
            ...
            <Alert tone="destructive">
              ...
              <AlertDescription>
                ...
                <span className="text-muted-foreground">
                  コード{" "}
                  <code className="tabular-nums">KINTAI_FETCH_504</code> ・ リクエストID{" "}
            ...
            <div className="p-4 pb-0">
              <Alert tone="warning">
                ...
                <AlertDescription>
                  ...
                  <span className="text-muted-foreground">
                    コード{" "}
                    <code className="tabular-nums">KINTAI_PARTIAL_倉庫</code> ・ リクエストID{" "}
        ...
        <TableShell
          caption={
            <Flex direction="row" align="center" gap="xs">
              ...
              <span className="tabular-nums">5 件 · 14:32 更新</span>
            </Flex>
          }
        >
