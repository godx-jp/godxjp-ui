...
/**
 * List-page screen — DataTable lives full-bleed inside a variant="flush"
 * PageContainer; the page title + "新規" action are the header, bulk actions
 * appear only when rows are selected. A complete, real admin list.
 */
...
const invoices: Invoice[] = [
  ...
  { id: "INV-2024-0309", partner: "東京ロジ", amount: 312000, status: "failed", date: "2024-04-09" },
