...
const accounts = [
  ...
  { id: "1110", title: "現金及び預金", description: "普通・当座・小口", depth: 2, badge: "3 口座", active: true },
...
export default function Demo() {
  return (
    <PageContainer title="TreeList" subtitle="Hierarchical list — depth lives in the data, not the DOM">
      <Flex direction="col" gap="lg">
        <Card>
          <CardHeader>
            <CardTitle>勘定科目ツリー</CardTitle>
            <CardDescription>Pre-filter server-side; each item still carries its depth.</CardDescription>
          </CardHeader>
          <CardContent>
