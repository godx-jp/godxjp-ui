...
Radio — Primitive nhập liệu — form control và lựa chọn giá trị.
...
Root radio group — single select.

**Use case:** `defaultValue` hoặc controlled `value`.
...
**Use case:** `value` bắt buộc; đặt trong RadioGroupRoot.
