...
DatePicker — Primitive nhập liệu — form control và lựa chọn giá trị.
...
| ------------- | -------------------------- | -------- | -------------------------------- | --------------------------------------------------------- |
| `value`       | `Date`                     | —        | Giá trị hiển thị chính.          | StatCard: số KPI; Select controlled: option đang chọn.    |
...
| Prop       | Kiểu                                | Mặc định | Mô tả                             | Use case                                   |
| ---------- | ----------------------------------- | -------- | --------------------------------- | ------------------------------------------ |
| `onChange` | `(date: Date`, `undefined) => void` | —        | Xử lý khi giá trị input thay đổi. | Controlled Input/Select — sync state form. |
