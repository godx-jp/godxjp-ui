...
ColorPicker — Primitive nhập liệu — form control và lựa chọn giá trị.
...
| Prop       | Kiểu                    | Mặc định | Mô tả                             | Use case                                   |
| ---------- | ----------------------- | -------- | --------------------------------- | ------------------------------------------ |
| `onChange` | `(hex: string) => void` | —        | Xử lý khi giá trị input thay đổi. | Controlled Input/Select — sync state form. |
