...
Popover — Primitive hiển thị dữ liệu — chỉ đọc, không nhập liệu.
...
PopoverContent — phần con của compound primitive.
...
PopoverDescription — phần con của compound primitive.
...
PopoverHeader — phần con của compound primitive.
...
PopoverTitle — phần con của compound primitive.
...
PopoverTrigger — phần con của compound primitive.
