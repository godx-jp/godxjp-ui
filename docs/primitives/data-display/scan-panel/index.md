...
ScanPanel — Primitive hiển thị dữ liệu — chỉ đọc, không nhập liệu.
...
```tsx
import { ScanPanel } from "@godxjp/ui/data-display";
```
...
| `description` | `string` | —            | Nội dung mô tả chi tiết. | Dialog/EmptyState/Alert — body text giải thích.           |
